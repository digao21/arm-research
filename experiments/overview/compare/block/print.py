...
files = ['bsc/cache.csv', 'sdumont/cache.csv']
colors = ['r', 'g']
...
# Plot speedup
dataBsc = genfromtxt('bsc/cache.csv', delimiter=';')
dataSdm = genfromtxt('sdumont/cache.csv', delimiter=';')
...
files = ['bsc/ipc.csv', 'sdumont/ipc.csv']
colors = ['r', 'g']
