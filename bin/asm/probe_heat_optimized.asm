	...
	.file	"probe_heat_optimized.c"
	.text
	.align	2
	.global	StencilProbeOptimized
	.type	StencilProbeOptimized, %function
StencilProbeOptimized:
	sub	sp, sp, #272
	cmp	w5, wzr
	stp	d8, d9, [sp,80]
	stp	x19, x20, [sp]
...
.L1:
	...
	add	sp, sp, 272
	ret
	.size	StencilProbeOptimized, .-StencilProbeOptimized
